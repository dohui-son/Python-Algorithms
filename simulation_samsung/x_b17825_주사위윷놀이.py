g = [[1],[2],[3],[4],[5], [6,21],[7],[8],[9],[10], [11,25],[12],[13],[14],[15], [16,27], [17],[18],[19],[20], [32], [22],[23],[24],[30], [26],[24], [28],[29],[24], [31], [20], [32]]
...
def check(horse, cnt, point):
  ...
  for j in range(4):
    ...
    if len(g[pos]) > 1: pos = g[pos][1]
    else : pos = g[pos][0]

    for i in range(1, dices[cnt]): pos = g[pos][0]
